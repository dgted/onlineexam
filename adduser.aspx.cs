       ...
       private void GenerateAutoId()
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
...

        {
            ...
            SqlCommand cmd = new SqlCommand("insert into Ulogin values (@username, @password, @student,@admin, @teacher, @rollno)", con);
            ...
            cmd.Parameters.AddWithValue("teacher", "0");
            cmd.Parameters.AddWithValue("rollno", Label.Text);
            cmd.ExecuteNonQuery();
            Label4.Visible = true;
            Label4.Text = "Student registered successfully";
