...
<br />
           ...
           <tr>
                <td class="auto-style10">
                    ...
                    <asp:TextBox ID="TextBox1" runat="server" style="margin-left: 0px; background-color: #FFFFCC;" Width="254px" align ="center" Height="43px"></asp:TextBox>
...
<br />
            ...
            <tr>
                <td class="auto-style5">
                    ...
                    <asp:TextBox ID="TextBox2" runat="server" style="margin-left: 0px; background-color: #FFFFCC;" TextMode="Password" Width="251px" Height="41px"></asp:TextBox>
...
<br />
            ...
            <tr>
                <td class="auto-style3">
                    <br />
                    <asp:Button ID="Button1"  runat="server" Text="Register" OnClick="Button1_Click" style="color: #FFFFFF; margin-left: 0px; background-color: #9933FF; text-align: center;" Width="377px" />
                <br />
<br />
                </td>
